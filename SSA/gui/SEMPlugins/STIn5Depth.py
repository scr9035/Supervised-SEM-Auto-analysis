...
class STIn5Depth(NormalDist):
    ...
    def __init__(self):
        ...
        self._auto_CD = self._STIn5AutoDepth
        self.data = {}
        
        try:
            with open('STIn5DepthSetting.json', 'r') as f:
    ...
    def clean_up(self):
        self._saveSettings('STIn5DepthSetting.json')
        super().clean_up()
    ...
    def _STIn5AutoDepth(self, image, interface=None):
        ...
        if interface is None:            
            ...
            channel_count, reference, _depth, _depth_points, channel_center, plateau \
                            = channel.FinDepth(image, find_ref=True, 
                                               threshold=self._threshold,
            ...
            channel_count, reference, _depth, _depth_points, channel_center, plateau \
                            = channel.FinDepth(image, find_ref=interface, 
                                               threshold=self._threshold, 

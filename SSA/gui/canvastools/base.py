...
class CanvasToolBase(object):
    ...
    def __init__(self, manager, on_move=None, on_mouse_release=None, on_key_press=None,
                 on_key_release=None, useblit=True, ax=None):
        ...
        self.callback_on_mouse_release = _pass if on_mouse_release is None else on_mouse_release
        self.callback_on_key_press = _pass if on_key_press is None else on_key_press
        self.callback_on_key_release = _pass if on_key_release is None else on_key_release
...
#    @property
#    def delete(self):
#        """delete function that gets passed to callback functions."""
#        return
